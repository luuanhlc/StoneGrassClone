...
namespace CityBuilder.UI
{
    ...
    public class UIBuildingCatalogue : MonoBehaviour
    {
        ...
        public static UIBuildingCatalogue Ins;
        public BuildGameMode mode;
        private void Awake()
        {
            Ins = this;
        ...
        {
            CityBuildingData[] availableBuildings = GameController.Ins.availableBuildings;
        ...
        private void CreateCatalogueItem(CityBuildingData buildingData)
        {
            ...
            catalogueItemInstance.GetComponent<UICatalogueItem>().ResetBtn();
        }
