...
public class MaxMediationController : MonoBehaviour
{
    ...
    private const string InterstitialAdUnitId = "89b1fe2f2686ca2d";
    private const string RewardedAdUnitId = "3ee31bfed25bc4c7";
    private const string RewardedInterstitialAdUnitId = "ENTER_REWARD_INTER_AD_UNIT_ID_HERE";
    private const string BannerAdUnitId = "d32cc3918c50a03c";
    ...
    private void OnRewardedAdReceivedRewardEvent(string adUnitId, MaxSdk.Reward reward, MaxSdkBase.AdInfo adInfo)
    {
        ...
        PlayerDataManager.SetNumberPlay(-1);
    }
