...
public class RocketConfig
{
    ...
    public const string package_name = "com.unicorn.block.squid";

    public static string default_cp = "default_bigfox";
    public const string VersionName = "1.0.6";
    public const int versionCode = 20006;
    public const string ProductName = "Roblock Squid: Survival Game";
