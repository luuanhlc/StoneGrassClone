...
public class RewardLuckyWheel : MonoBehaviour
{
    ...
    public void Init(DataRewardLuckyWheel dataLuckyWheel)
    {
        ...
        /*switch (dataLuckyWheel.Type)
        {
            ...
            case TypeGift.HAT:
                {
                    if (PlayerDataManager.GetUnlockSkin(TypeEquipment.Hat, dataLuckyWheel.IdType))
                    {
                        iconReward.sprite = playerData.DataTexture.IconCoinLuckyWheel;
                    ...
                    {
                        iconReward.sprite = playerData.DataTextureSkin.GetIcon(TypeEquipment.Hat, dataLuckyWheel.IdType);
            ...
            case TypeGift.SKIN:
                {
                    if (PlayerDataManager.GetUnlockSkin(TypeEquipment.Skin, dataLuckyWheel.IdType))
                    {
                    ...
                    {
                        iconReward.sprite = playerData.DataTextureSkin.GetIcon(TypeEquipment.Skin, dataLuckyWheel.IdType);
                        txtNumberCoin.gameObject.SetActive(false);
                    }
                }
                break;
            case TypeGift.PET:
                {
                    if (PlayerDataManager.GetUnlockSkin(TypeEquipment.Pet, dataLuckyWheel.IdType))
                    {
                        iconReward.sprite = playerData.DataTexture.IconCoin;
                        txtNumberCoin.text = dataLuckyWheel.NumberCoinReplace.ToString();
                    }
                    ...
                    {
                        iconReward.sprite = playerData.DataTextureSkin.GetIcon(TypeEquipment.Pet, dataLuckyWheel.IdType);
                        txtNumberCoin.gameObject.SetActive(false);
                    }
                }
                break;
