...
public class ShopTab : MonoBehaviour
{
    ...
    private List<ItemSkinShop> itemSkins = new List<ItemSkinShop>();
    ...
    public void Reset()
    {
        ...
        //GameManager.Instance.UiController.ShopCharater.SetupTabBottom(currentIndex, GetTotalPage(itemSkins.Count));
    }
